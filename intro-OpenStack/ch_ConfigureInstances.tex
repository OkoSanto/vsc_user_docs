...
{\emph{Add a key pair} on page \pageref{add-a-key-pair}.
...
\strong{Note:} When adding a rule, you must specify the protocol used
...
\strong{Note:} To accept requests from a particular range of IP
